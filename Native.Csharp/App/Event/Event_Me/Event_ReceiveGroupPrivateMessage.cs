...
namespace Native.Csharp.App.Event.Event_Me
{
    ...
    public class Event_ReceiveGroupPrivateMessage : IReceiveGroupPrivateMessage
    {
        ...
        public void ReceiveGroupPrivateMessage(object sender, CqPrivateMessageEventArgs e)
        {
            ...
            {
                Common.CqApi.SendPrivateMessage(e.FromQQ, "天杀的错误！");
            }
...
表达式格式：'骰子+清点*2'，当前支持的环境变量：骰子、清点");
            ...
            //用户输入指令
            if (input.Length > 2 && !botCloseList.Exists((long f) => f == e.FromQQ))
            {
                int vvc = 0;
...
{loofak}");
                ...
                //case "报错":
                //    Common.CqApi.SendPrivateMessage(1045740922, Attributes(input));
                //    Common.CqApi.SendPrivateMessage(e.FromQQ, "感谢您的反馈！这将帮助改进桌游姬！");
                //    return;
                ...
                //    if (pt == "None")//屁民瞎发啥指令
                //    {
                //        Common.CqApi.SendPrivateMessage(e.FromQQ, "权限不足！");
                //        return;
                //    }
                ...
                //        {
                //            Common.CqApi.SendPrivateMessage(e.FromQQ, "感谢你的支持，再见！");
                //            Common.CqApi.SetGroupExit(e.FromQQ, false);
                //            return;
                //        }
                //        return;//踢的不是我，溜了溜了
                //    }
                ...
                //    catch (Exception)
                //    {
                //        Common.CqApi.SendPrivateMessage(e.FromQQ, "抛出错误！");
                //        return;
                //    }
                //    Common.CqApi.SendPrivateMessage(e.FromQQ, "清理完成！");
                //    return;
