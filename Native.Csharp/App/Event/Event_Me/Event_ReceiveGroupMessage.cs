...
{loofak}");
                ...
                case "退群":
                    Event_Variable.groupId = e.FromGroup;
                    Event_Variable.qqId = e.FromQQ;
                    member = Common.CqApi.GetMemberInfo(Event_Variable.groupId, Event_Variable.qqId, true);//获取群成员
                ...
                case "日志":
                    Common.CqApi.SendGroupMessage(e.FromGroup, Event_Variable.updateLogDescription);
                    return;
